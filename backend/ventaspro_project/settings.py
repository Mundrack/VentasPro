"""
Configuración de Django para VentasPro
"""
...
SECRET_KEY = config(
    'SECRET_KEY',
    default='django-insecure-desarrollo-clave-temporal-cambiar-en-produccion-123456'
)
...
ROOT_URLCONF = 'ventaspro_project.urls'
